  ...
  <teleport to="body">
    <transition name="wheel-guide-modal">
      ...
      >
        ...
        >
          <header class="wheel-guide-modal__header">
            <div>
              <p class="wheel-guide-modal__eyebrow">How It Works</p>
              <h2 id="wheel-guide-title" class="wheel-guide-modal__title">
                The Wheel Strategy: Your Guide to Consistent Options Income
              </h2>
              <p class="wheel-guide-modal__lead">
            ...
            <button class="wheel-guide-modal__close" type="button" @click="emit('close')">
              Close
            </button>
          </header>

          <div class="wheel-guide-modal__body">
            <section class="wheel-guide-modal__section">
            ...
            <section class="wheel-guide-modal__section">
              <div class="wheel-guide-section-heading">
                ...
                <h3>Current Prime Wheel candidates from the Daily Brief</h3>
              </div>
              ...
              <div v-else class="wheel-guide-candidate-empty">
                Daily Brief candidates will appear here once the market scan loads.
              </div>
            </section>
          </div>
        </section>
...
.wheel-guide-modal__body {
  display: grid;
  gap: 28px;
  padding: 28px;
}

.wheel-guide-modal__section {
  display: grid;
  gap: 18px;
}
